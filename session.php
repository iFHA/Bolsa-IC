...
$group = get_group(required_param('groupid', PARAM_INT),$invertclass->id);
...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          ...
          <?php 
            ...
            //$url_chat->param('id',$invertclass->chat);

            $url_chat = new moodle_url('/mod/chat/gui_ajax/index.php');
            $url_chat->param('id',$invertclass->id);
    ...
    <div class="col-md-12">
      ...
      <!--                        SE FOR FACILITADOR                          -->
      <!-- ################################################################## -->
      <?php if(invertclass_is_enrolled($context, "editingteacher") && $session->finished){ ?>
    <div class="col-md-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
      ...
      <!--                        SE FOR ESTUDANTE                          -->
      <!-- ################################################################## -->
      <?php if(invertclass_is_enrolled($context, "student") && $session->finished){ ?>
    <div class="col-md-12">
      <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title">Avaliação de sessão</h3>
