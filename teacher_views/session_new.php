      ...
      <div class="panel panel-primary">
        ...
        <!-- ################################################################## -->
          ...
          <form action="teacheractions.php" method="POST" class="form-horizontal" role="form" >
            ...
            <input id="groupid" name="groupid" type="hidden" value="<?php echo $group->id; ?>">
            ...
            <input id="action" name="action" type="hidden" value="add_session">
            ...
            <fieldset>
              <div class="form-group">
                ...
                <div class="input-group date form_datetime col-md-5" data-date="" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
                  <input class="form-control" id="timestart" name="timestart" size="16" type="text" readonly>
              ...
              <dl class="dl-horizontal">
                ...
                <dd>
                  ...
                  <div class="radio">
                    <label> <input type="radio" name="last" id="last_2" value="0" chacked> Não </label>
                  </div>
                <dd>
              </dl>
              <hr />
